...
},{"./graphicEqualizer":2,"./graphicEqualizerUi":4,"jquery":8}],2:[function(require,module,exports){
...
var hogan = require("hogan.js");var n = new hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"global-controls\">\r");t.b("\n" + i);t.b("<label>Bypass <input class=\"bypass\" type=\"checkbox\" accesskey=\"b\"></label>\r");t.b("\n" + i);t.b("<button class=\"reset\" accesskey=\"r\">Reset</button>\r");t.b("\n" + i);t.b("<label>Q: <input class=\"q\" type=\"range\" value=\"1.0\" min=\"0.1\" max=\"10.0\" step=\"0.1\" accesskey=\"q\"></label>\r");t.b("\n" + i);t.b("</div>\r");t.b("\n" + i);t.b("\r");t.b("\n" + i);t.b("<div class=\"bands\">\r");t.b("\n" + i);if(t.s(t.f("frequencyBands",c,p,1),c,p,0,317,490,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<span class=\"band\"><label>\r");t.b("\n" + i);t.b("<div class=\"frequency\">");t.b(t.v(t.f("frequency",c,p,0)));t.b("</div>\r");t.b("\n" + i);t.b("<input class=\"gain\" type=\"range\" orient=\"vertical\" value=\"0\" min=\"-30\" max=\"30\">\r");t.b("\n" + i);t.b("</label></span>\r");t.b("\n" + i);});c.pop();}t.b("</div>\r");t.b("\n");return t.fl(); },partials: {}, subs: {  }});module.exports = function(data, partials) {return n.render(data, partials)}
},{"hogan.js":6}],4:[function(require,module,exports){
...
},{"./graphicEqualizer.mustache":3,"jquery":8}],5:[function(require,module,exports){
/*
